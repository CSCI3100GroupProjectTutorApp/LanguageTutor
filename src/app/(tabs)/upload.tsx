...
const upload = () => {
  ...
  const handleUpload = async() => {
    ...
    try{
      ...
      if (!isAuth){
        setErrorMessage("No Auth")
      }
      const formData = new FormData()
      
      if (photo || (selectFile && (selectFile.mimeType === "image/jpeg" || selectFile.mimeType === "image/png" ))){
        if (photo) {
          const file ={
            uri: photo.uri,
            type: photo.type,
            name: "upload_photo.jpg"  
          }  as unknown as Blob
      ...
      else if (selectFile && selectFile.mimeType !== "image/*"){
        setErrorMessage("Not image file")
      }
      else{
